            ...
            using (cancellationToken.Register(() => tcs.TrySetResult()))
            {
                ...
                WebAssemblyCallQueue.Schedule((_rootComponents, _renderer, initializationTcs), static async state =>
                {
                    ...
                    try
                    {
                        ...
                        {
                            var componentId = renderer.AddRootComponent(rootComponent.ComponentType, rootComponent.Selector);
                            await renderer.RenderRootComponentAsync(componentId, rootComponent.Parameters);
                        }
